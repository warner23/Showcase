  ...
  <div class="site-wrap">
    ...
    <section id="main_content" class="inner">
      <form class="build-form clearfix">
        <div class="stageWrap"> <ul class="stage empty-stage" style="min-height: 528.594px;"></ul></div>
