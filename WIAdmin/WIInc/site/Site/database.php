 <form  class="form-horizontal database-form" id="database">
                      <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-lg-8">
                                <input type="text" id="db_username" class="input-xlarge form-control" maxlength="160" placeholder="Username" name="db_username" value="<?php echo $site->Website_Info('db_username')?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-lg-8">
                                <input type="password" id="db_pass" class="input-xlarge form-control" maxlength="160" placeholder="Password" name="db_pass" value="<?php echo $site->Website_Info('db_pass')?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls col-lg-8">
                                <input type="text" id="db" class="input-xlarge form-control" maxlength="160" placeholder="Database" name="db" value="<?php echo $site->Website_Info('db_name')?>">
                            </div>
                        </div>
