    ...
    display: block;
          ...
          <div class="span9 users-wrapper">
             ...
             <!-- <?php  //$user_role 3 => admin ?> -->
              <?php $users = $WIdb->select("SELECT * FROM `wi_members` WHERE `user_role` < 4 ORDER BY `register_date` DESC"); ?>
...
<!--                          <td>--><?php //echo $user['last_login']; ?><!--</td>-->
        ...
        <div class="modal" id="modal-user-details" style="display: none;">
           ...
           <div class="modal <?php echo BOOTSTRAP_VERSION == 2 ? "hide" : "fade" ?> hide" id="modal-change-role">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
