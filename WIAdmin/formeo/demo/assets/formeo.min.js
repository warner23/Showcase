/*!
 * wi_pageBuilder - https://wi_pageBuilder.io
 * Version: 0.7.17
...
t.p="/assets/",t(t.s=24)}([function(module,exports,__webpack_require__)
	{
		"use strict";
...
function DOM(){
	...
	,this.styleSheet=function(){
		...
		return e.setAttribute("media","screen"),
...
if(elem.options){
	...
	if(options=this.processOptions(options,elem,isPreview),
		...
		delete elem.content,processed.push("options")
	}
	if(elem.attrs&&(_this.processAttrs(elem,element,isPreview),processed.push("attrs")),elem.config){
		...
		elem.config.hideLabel?editablePreview&&(element.contentEditable=!0):_this.labelAfter(elem)?(wrap.className="f-"+elem.attrs.type,label.insertBefore(element,label.firstChild),
			wrap.content.push(label),
			required&&wrap.content.push(requiredMark)):(wrap.content.push(label),
			required&&wrap.content.push(requiredMark),
...
DOM.prototype.icon=function(e){
	...
	delete n.tag,
	o||n.name||!this.isInput(e.tag)||t.setAttribute("name",(0,_utils.uuid)(e)),Object.keys(n).forEach(function(e){
...
t&&(delete o.attrs.for,o.attrs.contenteditable=!0,o.fMap=t),
dom.create(o)
},
...
DOM.prototype.clone=function(e,t){
	...
	_data2.formData[n].set(i.id,i),t||(t=e.parentElement,l=!0),
	{
		rows:function(){
			i.columns=[];
			var t=o.activeStage,
...
DOM.prototype.formGroup=function(e){
	return{
		tag:"div",
		className:["f-field-group",1<arguments.length&&void 0!==arguments[1]?arguments[1]:""],content:e
	}}
